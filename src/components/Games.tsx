    ...
    return(
        <div className="row">
            ...
            <div className="column">
                ...
                <Link to="/horizon"><img className="small" src={require('../images/small/horizon.jpg')} alt=""/></Link>
            ...
            <div className="column">
                ...
                <Link to="/dirt5"><img className="small" src={require('../images/small/Dirt_5_cover_art.jpg')} alt=""/></Link>
            ...
            <div className="column">
                ...
                <Link to="/forbiddenWest"><img className="small" src={require('../images/small/Horizon_Forbidden_West_cover_art(1).jpg')} alt=""/></Link>
                ...
                <Link to="/mortalKombat11"><img className="small" src={require('../images/small/Mortal_Kombat_11_cover_art.png')} alt=""/></Link>
                <Link to="/mafia"><img className="large" src={require('../images/large/Mafia_Definitive_Edition.jpg')} alt=""/></Link>
            </div>

            <div className="column">
                <Link to="/hitman3"><img className="small" src={require('../images/small/Hitman_3_Packart.jpg')} alt=""/></Link>
                <Link to="/gtaV"><img className="small" src={require('../images/small/Grand_Theft_Auto_V.png')} alt=""/></Link>
                <Link to="/justCause4"><img className="small" src={require('../images/small/Just_Cause_4_cover.jpg')} alt=""/></Link>
